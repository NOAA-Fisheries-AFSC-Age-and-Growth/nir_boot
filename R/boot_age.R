...
#import TMA age error data, bias columns are (expected age-0.5)
{
  ...
  TMA_bias[,1] <- (as.numeric(read.csv("./data/7_reader_TMA_TMB_Age_23/Results/Pollock SS3_format_Reader1.csv", header=TRUE)[5,-1])-0.5)
  TMA_bias[,2] <- (as.numeric(read.csv("./data/7_reader_TMA_TMB_Age_23/Results/Pollock SS3_format_Reader2.csv", header=TRUE)[5,-1])-0.5)
  TMA_bias[,3] <- (as.numeric(read.csv("./data/7_reader_TMA_TMB_Age_23/Results/Pollock SS3_format_Reader3.csv", header=TRUE)[5,-1])-0.5)
  TMA_bias[,4] <- (as.numeric(read.csv("./data/7_reader_TMA_TMB_Age_23/Results/Pollock SS3_format_Reader4.csv", header=TRUE)[5,-1])-0.5)
  TMA_bias[,5] <- (as.numeric(read.csv("./data/7_reader_TMA_TMB_Age_23/Results/Pollock SS3_format_Reader5.csv", header=TRUE)[5,-1])-0.5)
  TMA_bias[,6] <- (as.numeric(read.csv("./data/7_reader_TMA_TMB_Age_23/Results/Pollock SS3_format_Reader6.csv", header=TRUE)[5,-1])-0.5)
  TMA_bias[,7] <- (as.numeric(read.csv("./data/7_reader_TMA_TMB_Age_23/Results/Pollock SS3_format_Reader7.csv", header=TRUE)[5,-1])-0.5)
